...
LIBS	:=	-lSDL2_image -lSDL2 -lpng -lz -ljpeg -lwebp -lglad -lEGL -lglapi -ldrm_nouveau -lstdc++ -lvorbisidec -logg -lmpg123 -lmodplug -ltwili -lnx -lfreetype -lbz2 -lmupdf_core -lmupdf_thirdparty -lconfig -lm
